...
<body align="center">
<h3>My Orders (Nearby Restaurants - Same Place/District)</h3>
<?php
// Get bookings ready for delivery (status 3 = packed, waiting for collection) from restaurants in same place or district
        ...
        ?>
            <tr>
                ...
                <td>
                    ...
                    echo $currentStatus == 3 ? 'Packed - Ready for Collection' : 
        ...
        <tr>
            <td colspan="8">
                ...
                if ($status == 3) { // Packed - Delivery boy can collect
                    ...
                    ?>
                    <a href="ViewOrders.php?updateStatus=<?php echo $bookingData['booking_id']; ?>&status=4" onclick="return confirm('Collected and Shipped?');">Collect & Ship</a>
                    <?php
                } elseif ($status == 4) { // Collected - On the way
                    echo "Collected - Out for Delivery";
                    ?>
                    <a href="ViewOrders.php?updateStatus=<?php echo $bookingData['booking_id']; ?>&status=5" onclick="return confirm('Out for Delivery?');">Out for Delivery</a>
                    <?php
                } elseif ($status == 5) {
                    echo "Out for Delivery";
                    ?>
                    <a href="ViewOrders.php?updateStatus=<?php echo $bookingData['booking_id']; ?>&status=6" onclick="return confirm('Mark as Delivered?');">Mark Delivered</a>
                    <?php
                } elseif ($status == 6) {
                    echo "Delivered";
                } else {
